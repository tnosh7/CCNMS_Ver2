                            ...
                            <c:choose>
                            	...
                            	<c:otherwise>
									<c:choose>
		                            	...
		                            	<c:otherwise>
	                            	      	<div class="header__top__right__auth">
												<p><a href="${contextPath }/user/loginUser"><button type="button" class="btn btn-outline-dark">Sign in</button></a></p>
                            				</div>
		                               	  	<div class="header__top__right__language">
		                               			<p><a href="${contextPath }/user/register"><button type="button" class="btn btn-outline-success">Sing up</button></a></p>
	                            			</div>
		                            	</c:otherwise>
									</c:choose>                            
                            	</c:otherwise>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul style="b">
                            ...
                            <li><a href="${contextPath }/digging/main?diggingTopic=kPop"><img alt="상점에러" src="${contextPath }/resources/bootstrap/img/shop.png"> 디깅 </a>
                ...
                <div class="col-lg-12 text-center">
                    <div class="search__text">
                        <div class="search__option">
                          <form class="d-flex" action="${contextPath }/search" style="background:ghostwhite">
						     <input class="form-control me-sm-2" type="search" id="search" name="search" placeholder="검색어를 입력해 주세요." maxlength="100">
						     <button class="btn btn-secondary my-2 my-sm-0" type="submit" style=background:blue;>Search</button>
					     </form>
                        </div>
                    </div>
                </div>
